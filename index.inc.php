...
require_once('modules'.CC_DS.'3rdparty'.CC_DS.'page_view'.CC_DS.'range'.CC_DS.'boxes'.CC_DS.'ranges_box.inc.php');
if(!empty($ranges->range_id)) {
$body->assign('RANGES', $box_content);
}

require_once('modules'.CC_DS.'3rdparty'.CC_DS.'page_view'.CC_DS.'finish'.CC_DS.'boxes'.CC_DS.'finishes_box.inc.php');
