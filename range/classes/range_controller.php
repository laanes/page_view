...
class Range_Controller extends Page_Model {
	...
	parent::$context = $context;
		...
		parent::$context_id = $_GET['rangeId'];
	...
	$data = $this->get_data_by_id( array( 'range_name', 'range_description', 'range_title' ), 'range', 'range_id', parent::$context_id );
